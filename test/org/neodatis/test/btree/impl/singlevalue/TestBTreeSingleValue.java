...
public class TestBTreeSingleValue extends TestCase {
	...
	public void testDelete1000() throws Exception {
	...
	public void testDelete1000_2() throws Exception {
		IBTree btree = getBTree(3);
		int size = 1000;
		for (int i = 0; i < size; i++) {
			btree.insert(new Integer(i), "key " + i);
	...
	public void testDelete10000Alpha_4() throws Exception {
	...
	public void testDeleteInsert10000() throws Exception {
		IBTree btree = getBTree(3);
		int size = 2000;
		for (int i = 0; i < size; i++) {
			btree.insert(new Integer(i), "key " + i);

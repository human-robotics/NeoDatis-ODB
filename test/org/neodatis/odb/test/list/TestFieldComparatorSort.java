...
public class TestFieldComparatorSort extends ODBTest {
	public void test1() {
		...
		odb = open(baseName);
		Query q = odb.query(User.class).orderByAsc("name,id");
	...
	public void test1_2() {
		...
		odb = open(baseName);
		Query q = odb.query(User.class).orderByDesc("name,id");
		Objects<org.neodatis.odb.test.list.User> users = odb.getObjects(q);
		odb.close();
		if (k < 11)
			DisplayUtility.display("test1", users);
	...
	public void test2() {
		...
		odb = open(baseName);
		Query q = odb.query(User.class).orderByAsc("ok,id,name");
		Objects<org.neodatis.odb.test.list.User> users = odb.getObjects(q);
		odb.close();
	...
	public void test2_2() {
		...
		odb = open(baseName);
		Query q = odb.query(User.class).orderByDesc("ok,id,name");
		Objects<org.neodatis.odb.test.list.User> users = odb.getObjects(q);
		odb.close();

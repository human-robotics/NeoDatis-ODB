...
public class PerformanceTest2 {
	...
	public static final String ODB_FILE_NAME =  "perf2v2.neodatis";
	...
	public void testInsertSimpleObjectODB() throws Exception {
		...
		NeoDatisConfig config = NeoDatis.getConfig().setStorageEngineClass(JDBM3Plugin.class).setBaseDirectory("unit-test-data");

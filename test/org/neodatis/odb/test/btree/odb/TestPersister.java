...
public class TestPersister extends ODBTest {
	public void test1() throws Exception {
		...
		SessionEngine sessionEngine = Dummy.getEngine(odb);
		LazyODBBTreePersister persister = new LazyODBBTreePersister(sessionEngine);
		...
		sessionEngine = Dummy.getEngine(odb);
		persister = new LazyODBBTreePersister(sessionEngine);

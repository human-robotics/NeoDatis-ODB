...
public class TestNQQuery2 extends ODBTest {
	...
	public void test1() throws Exception {
		...
		Objects l = odb.getObjects(new NativeQuery<Function>() {
	...
	public void test4() throws Exception {
		...
		Query query = odb.query(new NativeQuery<User>() {
			public boolean match(User user) {
	...
	public void test5() throws Exception {
		...
		Query q = odb.query(query);
		q.getQueryParameters().setStartAndEndIndex(5,6);
		Objects l = query.objects();
		odb.close();
		assertFalse(l.isEmpty());
		assertEquals(1, l.size());
	...
	public void test8Ordering() throws Exception {
		...
		Objects l = odb.query(query).orderByAsc("name,email").objects();
		int i = 0;
		while (l.hasNext()) {
			User user = (User) l.next();
	...
	public void test9Ordering() throws Exception {
		...
		Objects l = odb.query(query).orderByDesc("name,email").objects();
		int i = l.size() - 1;
		;
		while (l.hasNext()) {
			User user = (User) l.next();

...
public class TestValuesQueryWithOid extends ODBTest {
	...
	public void test1() throws IOException, Exception {
		...
		odb = open(baseName);
		Values values = odb.queryValues(Handler.class, oid).field("parameters").sublist("parameters", "sub1", 1, 5,
				true).sublist("parameters", "sub2", 1, 10).size("parameters", "size").values();

...
public class TestPerfWriteLong extends ODBTest {
	...
	public void test2() {
		...
		for (int i = 0; i < size; i++) {
			...
			int writtenSize = NeoDatis.getConfig().getCoreProvider().getByteArrayConverter(false, "UTF-8", NeoDatis.getConfig()).longToByteArray(i,bytes,0,"bytes");
			assertEquals(8, writtenSize);

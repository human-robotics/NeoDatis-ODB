...
/**
 * A response to a GetObjectHeaderFromIdMessage command
 * @author olivier s
 *
 */
...
public class GetObjectHeaderFromIdMessageResponse extends Message {
	...
	public GetObjectHeaderFromIdMessageResponse() {
		super();
	}
	public GetObjectHeaderFromIdMessageResponse(String baseId, String connectionId, String error){
		super(MessageType.GET_OBJECT_HEADER_FROM_ID_RESPONSE, baseId,connectionId);
		setError(error);
	}
	...
	public ObjectInfoHeader getOih() {
		return oih;
	}
	public void setOih(ObjectInfoHeader oih) {
		this.oih = oih;
	}
	public String toString() {
		return "GetObjectHeaderFromIdResponse";
	}
